...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mesonpep517-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14334&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mesonpep517-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mesonpep517` can be installed with:

```
conda install mesonpep517
```

It is possible to list all of the versions of `mesonpep517` available on your platform with:
